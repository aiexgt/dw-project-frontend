...
const mostrar = (token, word) => {
  if (word != "" && word != null && word != undefined) {
    word = "http://34.125.111.145:80/pedido?word=" + word;
  } else {
    word = "http://34.125.111.145:80/pedido";
  }
...
const selectCliente = () => {
  ...
  fetch("http://34.125.111.145:80/cliente", requestOptions)
    .then((response) => response.text())
    .then((result) => {
      const info = JSON.parse(result);
...
const editar = (id, estado) => {
  ...
  fetch("http://34.125.111.145:80/pedido/" + id, requestOptions)
    .then((response) => response.text())
    .then((result) => {
      const info = JSON.parse(result);
      const template = `
...
const addPedido = () => {
  ...
  if (cliente != 0 && direccion != "" && tipoPago != 0) {
    ...
    fetch("http://34.125.111.145:80/pedido", requestOptions)
      .then((response) => response.text())
      .then((result) => {
        const info = JSON.parse(result);
        if (info.error) {
...
const cambiarEstado = () => {
  ...
  fetch("http://34.125.111.145:80/pedido/" + pedidoDetalle, requestOptions)
    .then((response) => response.text())
    .then((result) => {
      const info = JSON.parse(result);
      if (info.error) {
...
const eliminarDetalle = (id) => {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      fetch("http://34.125.111.145:80/detallePedido/" + id, requestOptions)
        .then((response) => response.text())
        .then((result) => {
          if (result != "") {
            Swal.fire({
...
const selectCategoria = (token) => {
  ...
  fetch("http://34.125.111.145:80/articulo/categoria", requestOptions)
    .then((response) => response.text())
    .then((result) => {
      const info = JSON.parse(result);
...
const selectArticulo = (categoria) => {
  ...
  fetch("http://34.125.111.145:80/articulo?categoria=" + categoria, requestOptions)
    .then((response) => response.text())
    .then((result) => {
      const info = JSON.parse(result);
      let template = '<option value="0">Seleccione una categoría</option>';
...
const selectCantidadArticulo = (articulo) => {
  ...
  fetch("http://34.125.111.145:80/articulo/" + articulo, requestOptions)
    .then((response) => response.text())
    .then((result) => {
      const info = JSON.parse(result);
      let template = "";
...
const añadirDetalle = (id) => {
  ...
  if (articulo != 0 && cantidad != 0) {
    ...
    fetch("http://34.125.111.145:80/detallePedido", requestOptions)
      .then((response) => response.text())
      .then((result) => {
        const info = JSON.parse(result);
        if (result.error) {
